using ECommerceBackend.Application.Features.Commands.AuthorizationEndpoint.AssignRoleEndpoint;
using ECommerceBackend.Application.Features.Queries.AuthorizationEndpoint.GetRolesToEndpoints;
using MediatR;
